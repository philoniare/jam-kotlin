...
class RustLibraryTest {
    ...
    fun testRingVrfCommitment() {
        ...
        val commitmentBytes = RustLibrary.generateRingRoot(publicKeys, ringSize)
    ...
    fun testRingVrfVerify() {
        ...
        val result = RustLibrary.verifierRingVrfVerify(entropyBytes, attempt, signatureBytes, gammaZBytes)
